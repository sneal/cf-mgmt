...
type GlobalConfig struct {
	...
	RunningEnvironmentVariableGroup map[string]interface{}  `yaml:"running-environment-variable-group"`
	StagingEnvironmentVariableGroup map[string]interface{}  `yaml:"staging-environment-variable-group"`
